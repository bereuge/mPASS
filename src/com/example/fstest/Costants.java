...
{
	//Client_id e client_secret per autorizzazione Foursquare
    ...
    //ID della FusionTable
    public static final String tableId="1QgevoMSjkSRXnPSe0065_jBjtY10uhjjcIQIHTs";
}
